...
$execute if items entity @s weapon.* minecraft:written_book[minecraft:custom_data={block_id:"chest"}] run execute at @n[nbt={UUID:$(UUID)},type=minecart] run playsound block.wood.place block @a ~ ~ ~ 1 0.8
$execute if items entity @s weapon.* minecraft:written_book[minecraft:custom_data={block_id:"tnt"}] run execute at @n[nbt={UUID:$(UUID)},type=minecart] at @s run playsound block.grass.place block @a ~ ~ ~ 0.8 0.8
$execute if items entity @s weapon.* minecraft:written_book[minecraft:custom_data={block_id:"furnace"}] run execute at @n[nbt={UUID:$(UUID)},type=minecart] at @s run playsound block.stone.place block @a ~ ~ ~ 1 0.8
$execute if items entity @s weapon.* minecraft:written_book[minecraft:custom_data={block_id:"hopper"}] run execute at @n[nbt={UUID:$(UUID)},type=minecart] at @s run playsound block.metal.place block @a ~ ~ ~ 1 1.8
