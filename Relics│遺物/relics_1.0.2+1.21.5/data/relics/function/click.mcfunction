...
$execute if entity @s[nbt={attack:{player:$(UUID)}}] run kill @s
$execute if entity @s[nbt={attack:{player:$(UUID)}}] as @e[type=block_display,tag=relics] run function relics:kill with entity @s data
$execute if entity @s[nbt={attack:{player:$(UUID)}}] as @e[type=item_display,tag=relics] run function relics:kill with entity @s data
