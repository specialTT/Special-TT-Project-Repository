...
execute as @e[type=minecraft:snow_golem] run function frozen:freeze with entity @s
...
execute at @e[type=minecraft:snow_golem] if block ~ ~-1 ~ water unless predicate {condition:"location_check",predicate:{biomes:["badlands","basalt_deltas","crimson_forest","desert","eroded_badlands","nether_wastes","savanna","savanna_plateau","soul_sand_valley","warped_forest","wooded_badlands"]}} run setblock ~ ~-1 ~ minecraft:ice
execute at @e[type=minecraft:snow_golem] if block ~ ~ ~ water unless predicate {condition:"location_check",predicate:{biomes:["badlands","basalt_deltas","crimson_forest","desert","eroded_badlands","nether_wastes","savanna","savanna_plateau","soul_sand_valley","warped_forest","wooded_badlands"]}} run setblock ~ ~ ~ minecraft:ice
