...
scoreboard players set @s copper_axe_broken 0
scoreboard players set @s copper_hoe_broken 0
scoreboard players set @s copper_pickaxe_broken 0
scoreboard players set @s copper_shovel_broken 0
scoreboard players set @s copper_spear_broken 0
scoreboard players set @s wooden_spear_broken 0
scoreboard players set @s stone_spear_broken 0
scoreboard players set @s iron_spear_broken 0
scoreboard players set @s golden_spear_broken 0
scoreboard players set @s diamond_spear_broken 0
scoreboard players set @s netherite_spear_broken 0
