...
kill @e[type=armor_stand,tag=VisualFire,tag=kill]
tag @e[type=armor_stand,tag=VisualFire] add kill
execute at @e[type=blaze,scores={fire_logic=1..}] run summon armor_stand ~ ~ ~ {HasVisualFire:1b,Invisible:1b,Invulnerable:1b,Tags:["VisualFire"]}