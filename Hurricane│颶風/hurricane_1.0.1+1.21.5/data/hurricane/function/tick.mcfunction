...
execute as @e[nbt={ticks_since_last_hurt_by_mob:1}] on attacker if entity @s[type=breeze] unless score @s wind_net matches 3..2147483647 run scoreboard players add @s wind_net 1
