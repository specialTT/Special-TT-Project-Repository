...
execute as @e[type=minecraft:villager,scores={is_sleeping=1,lost_health=1..}] unless predicate {condition:"entity_properties",entity:"this",predicate:{effects:{regeneration:{}}}} run effect give @s minecraft:regeneration 1 2 false